	...
	<section>
		...
		<table>
			...
			<%
				...
				try{
					String sql = "select a.productCode, a.productName, a.storeCode, b.storeName, a.unitprice, a.stockQty, (a.unitprice*a.stockQty) from product0214 a, store0214 b where a.storeCode=b.storeCode order by a.productCode";
			...
			<tr>
				...
				<td><%=stockQty %></td>
				<td><p id="p1"><%=df.format(t_price)%></p></td>
			</tr>
